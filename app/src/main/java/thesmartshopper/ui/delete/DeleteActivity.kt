package thesmartshopper.ui.delete
...
import thesmartshopper.MainActivity
import thesmartshopper.R
import thesmartshopper.us
import thesmartshopper.user.User
...
class DeleteActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buttonYes.setOnClickListener {
            ...
            val file = File("/data/data/thesmartshopper/files", "user.json")
