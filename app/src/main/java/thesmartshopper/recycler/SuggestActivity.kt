package thesmartshopper.recycler
...
import thesmartshopper.shop.Shop
import thesmartshopper.shop.article.Article
...
class SuggestActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val file = File("/data/data/thesmartshopper/files", "shops.json")
